...
namespace Chess.Core.Pieces
{
    ...
    {
        /// <summary>Gets the number of times the piece has moved.</summary>
        public int Moves { get; private set; }

        /// <summary>Gets the color of the piece.</summary>
        public PieceColor Color { get; init; }

        /// <summary>Gets the position of the piece on the board.</summary>
        public ChessPosition Position { get; private set; }

        /// <summary>Gets the board where the piece is.</summary>
        ...
        /// <summary>Changes the Position and increases the number of Moves.</summary>
        ...
        /// <summary>Increases the number of moves by 1.</summary>
        public virtual void IncreaseMoves()
        {
            Moves++;
        }

        /// <summary>Decreases the number of moves by 1.</summary>
