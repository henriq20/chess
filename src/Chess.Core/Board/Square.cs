...
{
    /// <summary>Represents a single square of a chessboard.</summary>
    public class Square
    {
        /// <summary>Gets an identifier of the square that is represented by a letter followed by a number.</summary>
        public ChessPosition Name { get; init; }

        /// <summary>Gets or Sets the square's piece.</summary>
        public ChessPiece Piece { get; set; }

        /// <summary>Gets a value indicating whether the piece is null.</summary>
        ...
        /// <summary>Takes the <see cref="Piece"/> out from the square.</summary>
